...
const MOCK_AGENTS = [
  { id: "agent-1", name: "Researcher", role: "Research", status: "active", tasks: 12 },
  { id: "agent-2", name: "Coder", role: "Engineering", status: "active", tasks: 8 },
  { id: "agent-3", name: "Writer", role: "Content", status: "idle", tasks: 3 },
  { id: "agent-4", name: "Reviewer", role: "QA", status: "idle", tasks: 5 },
  { id: "agent-5", name: "Planner", role: "Strategy", status: "error", tasks: 0 },
  { id: "agent-6", name: "Deployer", role: "DevOps", status: "active", tasks: 2 },
] as const;
