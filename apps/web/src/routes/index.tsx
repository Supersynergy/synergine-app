...
const FEATURES = [
	{
		...
		title: "Database",
		description:
			"Persistent storage for agent state, memory, and structured data.",
	...
	},
	{
		...
		title: "Messaging",
		description:
			"Event-driven queues for reliable agent-to-agent communication.",
	...
	},
	{
		...
		title: "Search",
		description:
			"Full-text and vector search across your agent knowledge base.",
	...
	},
	{
		...
		title: "Payments",
		description:
			"Monetize your agents with built-in billing and subscription flows.",
		...
		<div className="min-h-screen bg-background">
			...
			<section className="relative overflow-hidden px-4 pt-24 pb-20 text-center">
				...
				<div className="mx-auto max-w-3xl space-y-6">
					...
					>
						Orchestrate, coordinate, and scale intelligent agents with
						batteries-included backend services — database, cache, messaging,
						search, auth, and payments.
					</motion.p>
			...
			<section className="mx-auto max-w-5xl space-y-6 px-4 py-20">
				<motion.h2
					...
					viewport={{ once: true }}
					className="text-center font-medium text-muted-foreground text-sm uppercase tracking-widest"
				>
			...
			<section className="px-4 pb-24">
				<motion.div
					...
					className="mx-auto max-w-2xl space-y-4 rounded-2xl border border-border/60 bg-gradient-to-b from-muted/40 to-muted/10 px-8 py-12 text-center backdrop-blur"
				>
					<h2
